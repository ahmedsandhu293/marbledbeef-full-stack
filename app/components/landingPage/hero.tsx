  ...
  return (
    <div className="mb-[580px] md:mb-[380px] lg:mb-[280px]">
      ...
      <div className="relative flex justify-center items-center">
        <div
          className="absolute bottom-[-620px] md:bottom-[-420px] lg:bottom-[-320px] z-20 flex flex-col md:flex-row w-[90%] border border-gold rounded-xl shadow-lg"
        >
          {/* Video Section */}
          ...
          {/* Content Section */}
          <div className="flex flex-col justify-center bg-black text-white p-8 md:w-1/2 rounded-r-xl">
            <h4 className="text-lg font-medium uppercase text-gray-400">About Us</h4>
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
              We Provide <br />
              Best Meat
            </h2>
            <p className="text-gray-300 mb-6">
              Nous fournissons de la viande fraîche et biologique bien façonnée de
              notre ferme de manière très ingénieuse.
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center gap-2">
                <span className="bg-zinc-800 rounded-full p-1"><FaCheck /></span> Organic Meat
              </li>
              <li className="flex items-center gap-2">
                <span className="bg-zinc-800 rounded-full p-1"><FaCheck /></span> Payment
                Securisation
              </li>
            </ul>
            <div>
